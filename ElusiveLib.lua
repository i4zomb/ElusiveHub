if game:GetService("CoreGui"):FindFirstChild("ElusiveLib") then
    game:GetService("CoreGui"):FindFirstChild("ElusiveLib"):Destroy()
end
...
local library = {flags = {}, toggled = true, dragSpeed = 0.2}
...
local elusive = utility.create("ScreenGui", {})
elusive.Name = "ElusiveLib"
elusive.Parent = coreGui

local Mouse = game:GetService("Players").LocalPlayer:GetMouse()
Mouse.KeyDown:Connect(function(Key)
    if Key == "v" then
        library.toggled = not library.toggled
        elusive.Enabled = library.toggled
    end
end)
